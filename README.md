...
- Per-camera render-feature policy: TAA, fast AA, AO, SSR, and bloom are authored on `scrapbot.camera`; AO and SSR have bounded quality tiers, and disabled effects skip their GPU work.
