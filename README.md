...
- Per-camera render-feature policy: TAA, fast AA, AO, SSR, and bloom are authored on `scrapbot.camera`; AO has a bounded quality tier, and disabled effects skip their GPU work.
