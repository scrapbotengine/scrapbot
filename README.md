...
- RMB-captured WASD fly camera with Shift boost, precise entity picking, consumable UI interaction propagation, and translation/rotation/scale gizmos with pointer handles plus Blender-style constrained transform chords.
