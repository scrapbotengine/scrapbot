...
- Implementation Language
  ...
  - [x] Odin editor translate-gizmo local-space modifier slice
  - [x] Odin editor translate-gizmo persistent mode control slice
  ...
  - [x] Odin platform CI validation slice
