...
- RMB-captured WASD fly camera with Shift boost, MMB point-of-interest orbit, viewport wheel dolly, selected-entity framing, a depth-tested infinite world grid, precise entity picking, consumable UI interaction propagation, and snapped translation/rotation/scale gizmos with pointer handles plus Blender-style free modal transforms and later axis constraints.
