...
pub const RenderBenchmarkOptions = engine.RenderBenchmarkOptions;
pub const RenderBenchmarkResult = engine.RenderBenchmarkResult;
...
pub const renderBenchmarkFrames = engine.renderBenchmarkFrames;
