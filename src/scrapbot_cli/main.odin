...
Run_Options :: struct {
	...
	headless: bool `usage:"Run without a platform window; WGPU renders to an offscreen texture."`,
	...
	frames: u32 `usage:"Limit renderer frames. Windowed 0 runs until close; headless 0 renders one frame."`,
