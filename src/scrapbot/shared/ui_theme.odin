...
ui_theme_reduced_dark :: proc "contextless" () -> UI_Theme {
	return {
		palette = {
			canvas = {0.006, 0.006, 0.006, 1},
			region = {0.010, 0.010, 0.010, 1},
			panel = {0.016, 0.016, 0.016, 1},
			raised = {0.024, 0.024, 0.024, 1},
			control = {0.030, 0.030, 0.030, 1},
			overlay = {0.008, 0.008, 0.008, 0.98},
			border = {0.040, 0.040, 0.040, 1},
			border_strong = {0.075, 0.075, 0.075, 1},
			text = {0.87, 0.87, 0.87, 1},
			text_secondary = {0.63, 0.63, 0.63, 1},
			text_muted = {0.40, 0.40, 0.40, 1},
			accent = {0.20, 0.78, 0.66, 1},
			accent_text = {0.80, 1.00, 0.94, 1},
			accent_soft = {0.018, 0.085, 0.074, 1},
			hover = {0.048, 0.048, 0.048, 1},
			active = {0.064, 0.064, 0.064, 1},
		...
		metrics = {
			...
			gap = 8,
			gap_large = 12,
			padding_small = {4, 8, 4, 8},
			padding_control = {6, 8, 6, 8},
			padding_panel = {8, 8, 8, 8},
		},
		font = "Inter",
	}
}
