...
init_registry :: proc(registry: ^Registry) {
	...
	register_engine_component(
		...
		"scrapbot.ui_layout",
		{
			...
			Field_Definition{name = "border_dash_length", field_type = .Number},
			Field_Definition{name = "border_dash_gap", field_type = .Number},
			Field_Definition{name = "border_dash_offset", field_type = .Number},
	...
	register_engine_component(
		...
		"scrapbot.ui_dock_space",
		{
			...
			Field_Definition{name = "tab_connection_height", field_type = .Number},
			Field_Definition{name = "tab_content_overlap", field_type = .Number},
			Field_Definition {
				name = "tab_strip_background",
				field_type = .Vec4,
				editor = {color = true},
			},
			Field_Definition {
			...
			Field_Definition{name = "content_corner_radius", field_type = .Number},
			Field_Definition{name = "content_padding", field_type = .Vec4},
