...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 22)
	...
	testing.expect(t, camera.fields[11].name == "automatic_exposure")
	testing.expect(t, camera.fields[15].name == "temporal_antialiasing")
	testing.expect(t, camera.fields[18].name == "ambient_occlusion_quality")
	testing.expect(t, camera.fields[19].name == "screen_space_reflections")
	testing.expect(t, camera.fields[20].name == "screen_space_reflections_quality")
	testing.expect(t, camera.fields[21].name == "bloom")
