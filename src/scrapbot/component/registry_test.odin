...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 20)
	testing.expect(t, camera.fields[3].name == "debug_view")
	testing.expect(t, camera.fields[4].name == "resolution_scale")
	testing.expect(t, camera.fields[5].name == "dynamic_resolution")
	testing.expect(t, camera.fields[6].name == "dynamic_resolution_min_scale")
	testing.expect(t, camera.fields[7].name == "dynamic_resolution_target_ms")
	testing.expect(t, camera.fields[9].name == "automatic_exposure")
	testing.expect(t, camera.fields[13].name == "temporal_antialiasing")
	testing.expect(t, camera.fields[16].name == "ambient_occlusion_quality")
	testing.expect(t, camera.fields[17].name == "screen_space_reflections")
	testing.expect(t, camera.fields[18].name == "screen_space_reflections_quality")
	testing.expect(t, camera.fields[19].name == "bloom")
