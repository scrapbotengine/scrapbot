...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 16)
	testing.expect(t, camera.fields[3].name == "resolution_scale")
	testing.expect(t, camera.fields[5].name == "automatic_exposure")
	testing.expect(t, camera.fields[9].name == "temporal_antialiasing")
	testing.expect(t, camera.fields[12].name == "ambient_occlusion_quality")
	testing.expect(t, camera.fields[13].name == "screen_space_reflections")
	testing.expect(t, camera.fields[14].name == "screen_space_reflections_quality")
	testing.expect(t, camera.fields[15].name == "bloom")
