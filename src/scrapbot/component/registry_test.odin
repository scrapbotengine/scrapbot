...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 23)
	...
	testing.expect(t, camera.fields[20].name == "screen_space_reflections")
	testing.expect(t, camera.fields[21].name == "screen_space_reflections_quality")
	testing.expect(t, camera.fields[22].name == "bloom")
