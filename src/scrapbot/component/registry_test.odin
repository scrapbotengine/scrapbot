...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 15)
	testing.expect(t, camera.fields[4].name == "automatic_exposure")
	testing.expect(t, camera.fields[8].name == "temporal_antialiasing")
	testing.expect(t, camera.fields[11].name == "ambient_occlusion_quality")
	testing.expect(t, camera.fields[12].name == "screen_space_reflections")
	testing.expect(t, camera.fields[13].name == "screen_space_reflections_quality")
	testing.expect(t, camera.fields[14].name == "bloom")
