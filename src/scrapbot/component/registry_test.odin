...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 24)
	testing.expect(t, camera.fields[3].name == "debug_view")
	testing.expect(t, camera.fields[4].name == "debug_hiz_mip")
	testing.expect(t, camera.fields[5].name == "debug_occlusion_freeze")
	testing.expect(t, camera.fields[6].name == "resolution_scale")
	testing.expect(t, camera.fields[7].name == "dynamic_resolution")
	testing.expect(t, camera.fields[8].name == "dynamic_resolution_min_scale")
	testing.expect(t, camera.fields[9].name == "dynamic_resolution_target_ms")
	testing.expect(t, camera.fields[10].name == "adaptive_quality_minimum")
	testing.expect(t, camera.fields[12].name == "automatic_exposure")
	testing.expect(t, camera.fields[16].name == "temporal_antialiasing")
	testing.expect(t, camera.fields[19].name == "ambient_occlusion_quality")
	testing.expect(t, camera.fields[20].name == "ambient_occlusion_resolution_scale")
	testing.expect(t, camera.fields[21].name == "screen_space_reflections")
	testing.expect(t, camera.fields[22].name == "screen_space_reflections_quality")
	testing.expect(t, camera.fields[23].name == "bloom")
	...
	testing.expect(t, fog.field_count == 10)
	testing.expect(t, fog.fields[0].name == "color")
	testing.expect(t, fog.fields[1].name == "resolution_scale")
	testing.expect(t, fog.fields[2].name == "density")
	testing.expect(t, fog.fields[6].name == "anisotropy")
	testing.expect(t, fog.fields[9].name == "point_light_intensity")
	water, water_ok := find_definition(&registry, "scrapbot.water_volume")
	testing.expect(t, water_ok)
	testing.expect(t, water.storage_kind == .Custom)
	testing.expect(t, definition_is_authorable(water))
	testing.expect(t, water.field_count == 17)
	testing.expect(t, water.fields[0].name == "absorption")
	testing.expect(t, water.fields[2].name == "extents")
	testing.expect(t, water.fields[5].name == "transition_size")
	testing.expect(t, water.fields[6].name == "surface_displacement_bound")
	testing.expect(t, water.fields[12].name == "distortion_speed")
	testing.expect(t, water.fields[13].name == "caustics_intensity")
	testing.expect(t, water.fields[16].name == "caustics_max_depth")
	vignette, vignette_ok := find_definition(&registry, "scrapbot.vignette")
	flare, flare_ok := find_definition(&registry, "scrapbot.lens_flare")
	dirt, dirt_ok := find_definition(&registry, "scrapbot.lens_dirt")
	testing.expect(t, vignette_ok && flare_ok && dirt_ok)
	testing.expect(t, vignette.storage_kind == .Custom && definition_is_authorable(vignette))
	testing.expect(t, vignette.field_count == 5 && vignette.fields[2].field_type == .Vec2)
	testing.expect(t, flare.field_count == 8 && flare.fields[3].name == "ghost_count")
	testing.expect(t, dirt.field_count == 5 && dirt.fields[4].name == "seed")
