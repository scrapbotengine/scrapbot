...
export type Scrapbot = {
	...
	system: ((system: (delta_seconds: number) -> ()) -> ()) & ((options: ScrapbotSystemOptions, system: (delta_seconds: number) -> ()) -> ()) & ((query: ScrapbotQuery1<any, any>, system: (delta_seconds: number, entity: ScrapbotEntity, component: any) -> ()) -> ()) & ((query: ScrapbotQuery2<any, any, any, any>, system: (delta_seconds: number, entity: ScrapbotEntity, first: any, second: any) -> ()) -> ()) & ((query: ScrapbotQuery3<any, any, any, any, any, any>, system: (delta_seconds: number, entity: ScrapbotEntity, first: any, second: any, third: any) -> ()) -> ()) & (<A, RA>(query: ScrapbotQuery1<A, RA>, system: (delta_seconds: number, entity: ScrapbotEntity, RA) -> ()) -> ()) & (<A, RA, B, RB>(query: ScrapbotQuery2<A, RA, B, RB>, system: (delta_seconds: number, entity: ScrapbotEntity, RA, RB) -> ()) -> ()) & (<A, RA, B, RB, C, RC>(query: ScrapbotQuery3<A, RA, B, RB, C, RC>, system: (delta_seconds: number, entity: ScrapbotEntity, RA, RB, RC) -> ()) -> ()) & ((query: ScrapbotAnyQuery, options: ScrapbotSystemOptions, system: (...any) -> ()) -> ()),
