...
test_project_shaders_can_sample_engine_spectral_surfaces :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, strings.count(WGPU_SPECTRAL_SURFACE_SHADER, "@compute"), 3)
...
@(test)
test_editor_selection_marks_direct_and_model_owned_gpu_instances_only_on_change :: proc(
	t: ^testing.T,
) {
