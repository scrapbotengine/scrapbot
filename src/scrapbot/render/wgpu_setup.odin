...
wgpu_create_ui_pipeline :: proc(renderer:^WGPU_Renderer,state:^ui.State)->string {
	...
	attributes:=[?]wgpu.VertexAttribute{{format=.Float32x2,offset=0,shaderLocation=0},{format=.Float32x2,offset=8,shaderLocation=1},{format=.Float32x4,offset=16,shaderLocation=2},{format=.Float32,offset=32,shaderLocation=3},{format=.Float32x3,offset=36,shaderLocation=4},{format=.Float32x4,offset=48,shaderLocation=5}}
