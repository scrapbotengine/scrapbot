...
api_ui_theme_layout :: proc "contextless" (
	...
	return {
		...
		border_dash_length = value.border_dash_length,
		border_dash_gap = value.border_dash_gap,
		border_dash_offset = value.border_dash_offset,
	...
	switch name {
		...
		case "scrapbot.ui_dock_space":
			...
			payload.dock_space = {
				...
				tab_connection_height = value.tab_connection_height,
				tab_content_overlap = value.tab_content_overlap,
				tab_strip_background = api_vec4_from_shared(value.tab_strip_background),
				content_background = api_vec4_from_shared(value.content_background),
				content_corner_radius = value.content_corner_radius,
				content_padding = api_vec4_from_shared(value.content_padding),
	...
	switch name {
		case "scrapbot.ui_layout":
			...
			value := shared.UI_Layout_Component {
				...
				border_dash_length = payload.layout.border_dash_length,
				border_dash_gap = payload.layout.border_dash_gap,
				border_dash_offset = payload.layout.border_dash_offset,
		...
		case "scrapbot.ui_dock_space":
			value := shared.UI_Dock_Space_Component {
				...
				tab_connection_height = payload.dock_space.tab_connection_height,
				tab_content_overlap = payload.dock_space.tab_content_overlap,
				tab_strip_background = shared_vec4_from_api(
					payload.dock_space.tab_strip_background,
				),
				content_background = shared_vec4_from_api(payload.dock_space.content_background),
				content_corner_radius = payload.dock_space.content_corner_radius,
				content_padding = shared_vec4_from_api(payload.dock_space.content_padding),
