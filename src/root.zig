...
pub const renderBenchmarkFrames = render.renderBenchmarkFrames;
...
pub const RenderBenchmarkOptions = render.RenderBenchmarkOptions;
pub const RenderBenchmarkResult = render.RenderBenchmarkResult;
