...
| `src/scrapbot/geometry/` | Backend-independent crack-aware hierarchy construction, validation, cloning, and deterministic cluster-page partitioning. | Imported products and runtime Geometry use one representation; no renderer ownership or ordinary-frame construction. |
