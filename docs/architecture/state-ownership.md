...
buffers, aligned camera/shadow visibility slices, and indirect templates. Geometry versions define
...
they do not rescan resources or rebuild cluster metadata. Unsupported adapters and layouts above
