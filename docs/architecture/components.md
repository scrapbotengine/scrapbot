...
- **Producers:** Public project UI surfaces, editor entity/resource/system browsers, registry-driven component and reflected-enum pickers, and pointer interactions.
