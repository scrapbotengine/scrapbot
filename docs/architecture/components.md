...
- **Debug views:** Lit output, material inputs, mapped normals, logarithmic depth, retained meshlet identity, selected LOD, GPU visibility classification, false-color inspection of a selected retained Hi-Z mip, and freezeable screen-space Hi-Z query evidence.
