...
| `scrapbot.render.cull` | Encodes GPU visibility, resident virtual-geometry frontier selection and group feedback, frustum/Hi-Z rejection, LOD selection, and indirect visibility compaction. | WGPU frames; completed feedback may admit or evict complete index-page groups within frame limits. CPU-reference mode substitutes CPU culling and whole-primitive LOD selection. | `render/wgpu_gpu_driven.odin`, `render/wgpu_visibility.odin`, `render/wgpu_hiz.odin` |
