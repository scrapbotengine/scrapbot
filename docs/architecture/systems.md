...
| `scrapbot.render.cull` | Encodes GPU visibility, fully resident virtual-geometry frontier selection, frustum/Hi-Z rejection, LOD selection, and indirect visibility compaction. | WGPU frames; CPU-reference mode substitutes CPU culling and whole-primitive LOD selection. | `render/wgpu_gpu_driven.odin`, `render/wgpu_visibility.odin`, `render/wgpu_hiz.odin` |
