...
**Tradeoff:** Gizmo rendering is currently simple world-space box geometry. Local-space handles, rotation/scale modes, snapping, hover styling, occlusion behavior, and a broader editor transaction model are not covered yet.
