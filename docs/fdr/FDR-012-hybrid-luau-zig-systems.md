...
- **ADRs:** ADR-002, ADR-005, ADR-006, ADR-008, ADR-009, ADR-010
- **FDRs:** FDR-004, FDR-009, FDR-010, FDR-011

## Open Questions

- What is the first native registration surface: engine-linked Zig code, static per-game library, or dynamic module?
