...
- Users can run `machina render [--editor] [--select entity-id] [--frames N] [path] [output.png]` against a valid project.
- Users can run `machina render-test [--editor] [--select entity-id] [--frames N] [path] [output.png]` to render offscreen and verify the generated image.
