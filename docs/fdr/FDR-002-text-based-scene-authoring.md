...
- Engine component tables currently include `[entities.components."scrapbot.transform"]` with `position`, `rotation`, and `scale` `vec3` fields; `[entities.components."scrapbot.geometry.primitive"]` for built-in primitive selection; `[entities.components."scrapbot.material.surface"]` with base color; `[entities.components."scrapbot.renderer"]` for the scene renderer singleton; legacy `[entities.components."scrapbot.render.cube"]` with a `color` `vec3` field; `[entities.components."scrapbot.camera"]` with projection fields; `[entities.components."scrapbot.light.directional"]` with directional light fields; marker tables for `[entities.components."scrapbot.shadow.caster"]` and `[entities.components."scrapbot.shadow.receiver"]`; and UI tables such as `[entities.components."scrapbot.ui.canvas"]`, `[entities.components."scrapbot.ui.rect"]` with `position`, `size`, `color`, and `corner_radius`, `[entities.components."scrapbot.ui.text"]`, `[entities.components."scrapbot.ui.button"]`, `[entities.components."scrapbot.ui.command"]`, `[entities.components."scrapbot.ui.scroll_view"]`, `[entities.components."scrapbot.ui.vgroup"]`, `[entities.components."scrapbot.ui.hgroup"]`, `[entities.components."scrapbot.ui.stack"]`, `[entities.components."scrapbot.ui.layout.item"]`, `[entities.components."scrapbot.ui.spacer"]`, `[entities.components."scrapbot.ui.text_block"]`, `[entities.components."scrapbot.ui.toggle"]`, `[entities.components."scrapbot.ui.progress_bar"]`, and `[entities.components."scrapbot.ui.separator"]`.
- Runtime-only components such as `scrapbot.ui.command_event` and `scrapbot.input.*` are engine-owned transient data and should not be authored in scene files.
