...
The active camera controls fixed or automatic exposure, TAA, current-frame fast AA, half-resolution AO, SSR, and five-level bloom. AO maps an authored `0.25`–`1` quality value to four bounded 8/16/24/36-sample tiers, with balanced `0.5` as the default.
