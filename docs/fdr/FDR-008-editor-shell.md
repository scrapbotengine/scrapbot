...
- Publish a revisioned snapshot every five frames and copy in the renderer's latest GPU timestamp, retained-batch, camera-visible-batch, nonempty-meshlet-draw, instance, and visibility counters.
