...
- Require any future project-authored theme resource to resolve through the same component fields and typed mutation paths. It must not introduce a second renderer style store or stable-frame traversal.
