...
Scrapbot treats live reload of scripts, scenes, and related text-authored runtime resources as a core runtime capability, not an editor-only convenience.
