...
- Save is an explicit action available for dirty stopped scenes. It writes supported authored component values back to the scene TOML by stable entity UUID, preserves unrelated source structure and comments, and atomically replaces the file.
