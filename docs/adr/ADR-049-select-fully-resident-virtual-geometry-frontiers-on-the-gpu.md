...
Camera motion cannot safely reuse the previous camera's Hi-Z pyramid: newly revealed surfaces may
have stale occluders at the same screen coordinates. Disabling occlusion for the whole moving frame,
