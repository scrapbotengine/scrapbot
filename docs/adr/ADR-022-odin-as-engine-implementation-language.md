...
5. Port first-pass runtime foundations: component registry validation and generation-aware entity identity.
6. Port the rest of the pure engine foundations before backend-heavy systems: script/native component registry validation, math helpers, component storage, queries, schedules, and deferred mutation.
