...
**Migration note:** This record describes the current migration-era native module behavior. [ADR-023](ADR-023-odin-as-engine-implementation-language.md) makes Odin the target engine implementation language and requires a future Odin native-module contract to replace the Zig source contract.
