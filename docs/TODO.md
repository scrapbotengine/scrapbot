...
- [ ] Design a reusable water resource/component over project shaders: spectrum or FFT simulation, current/deformation masks, caustics, underwater rendering, water-aware motion vectors, and scalable quality tiers. Keep the current Virtual Wilds single-layer shader as the portable reference.
