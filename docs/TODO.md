...
- [ ] Bucket portable compact cluster records by triangle count to reduce fixed worst-case vertex work in depth, world, and shadow passes; validate the result against per-cascade profile workloads.
