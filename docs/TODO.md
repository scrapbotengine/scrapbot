...
- [ ] Add imported mesh LODs and offline simplification alongside the current generated icosphere LOD resources.
...
- [ ] Extend camera debug views with Hi-Z, object/meshlet visibility classification, and selected LOD.
