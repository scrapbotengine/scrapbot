...
- [ ] Prototype change-driven global distance-field clipmaps for world-space AO, soft shadows, particles, and measured coarse-occlusion assistance. Retain HZB as primary visibility until profiles justify otherwise. Runtime Geometry retention and the lazy GPU debug-slice cache are complete. See [ADR-055](adr/ADR-055-compile-mesh-distance-fields-offline.md).
