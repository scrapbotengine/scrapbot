...
- [ ] Retain Model v18 distance-field descriptors on runtime Geometry, add a debug slice view, then prototype change-driven global clipmaps for world-space AO, soft shadows, particles, and measured coarse-occlusion assistance. Retain HZB as primary visibility until profiles justify otherwise. See [ADR-055](adr/ADR-055-compile-mesh-distance-fields-offline.md).
