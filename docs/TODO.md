...
- [ ] Reduce first-import time and product size for multi-million-triangle virtual-geometry models; split Model catalogs, images, and pages into independently compressed product chunks.
