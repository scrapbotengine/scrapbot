...
- [ ] Add bounded residency pressure and explicit selected-record overflow diagnostics to `virtual-geometry-lab`, then gate its moving GPU/CPU coverage sequence in CI.
